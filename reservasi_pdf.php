...
$html .= '<html>';
$html .= '<head>';
$html .= '<title>HOTEL KITA</title>';
$html .= '</head>';
$html .= '<body>';

$sql = mysqli_query($dbconnect, "SELECT * FROM tb_reservasi ORDER BY res_id DESC LIMIT 1");
$d = mysqli_fetch_array($sql);
$tipe = $d['res_tipe'];
$sql2 = mysqli_query($dbconnect, "SELECT * FROM tb_jkamar WHERE jk_id=$tipe");
$d2 = mysqli_fetch_array($sql2);

$html .= '<center><h2>Reservasi Hotel Kita</h2></center>';
...
$dompdf->render();
$dompdf->stream('reservasi_hotel_ltf.pdf')
?>
skjsik